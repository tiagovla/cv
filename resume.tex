...
\begin{Projects}[https://github.com/tiagovla]
  \projectitem{Plane Wave Expansion Framework for Photonic Crystal Analysis}{https://github.com/tiagovla/morpho.py}
  \projectitem{FDTD Framework for Electromagnetic Simulations}{https://github.com/tiagovla/fdtd.py}
  \projectitem{Analytical Solutions for Electromagnetic Scattering}{https://github.com/tiagovla/scatsol}
  \projectitem{DGTD Framework for Electromagnetic Simulations}{https://github.com/tiagovla/oiseau}
  \projectitem{LaTeX package for generating professional curricula vitae}{https://github.com/tiagovla/cv}
  \projectitem{Contributions to FEniCSx (Open-source PDE solving platform)}{https://github.com/FEniCS}
\end{Projects}
